...
******************************************************************/
const tempretureGreater = temperatures.filter((temprature) => temprature >= 25);
const tempratureLess = temperatures.filter((temprature) => temprature < 20);
console.log(tempretureGreater);
console.log(tempratureLess);
/*****************************************************************
...
const warmMild = temperatures.map((temprature) => {
  if (temprature >= 25) return "warm";
  else if (temprature <= 24 && temprature >= 20) return "mild";
  else return "cool";
});
console.log(fahrenheit);
console.log(warmMild);
